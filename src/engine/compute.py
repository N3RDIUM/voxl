...
class ComputeManager:
    ...
    def enqueue(
        ...
        For more info, see
        :py:meth:`src.engine.compute.ComputePipeline.dispatch`.
...
class ComputePipeline:
    ...
    def _build_groups(
        ...
        Args:
            bindings (ComputeBindings): dictionary of bindings. See
                :py:data:`src.engine.types.ComputeBindings` for more.
        """
    ...
    def dispatch(
        ...
        :py:meth:`src.engine.compute.ComputeManager.compute_pass`
